...
//   const [message, setMessage] = useState(""); // To display message
...
//     try {
//       const response = await fetch("http://127.0.0.1:8000/upload", { // Backend URL
//         method: "POST",
//         body: formData,
//       });
...
//         setResult(data.output);    // Show pylint output
//       } else {
//         setMessage(`Error: ${data.message}`); // Handle error response
//       }
//     } catch (error) {
